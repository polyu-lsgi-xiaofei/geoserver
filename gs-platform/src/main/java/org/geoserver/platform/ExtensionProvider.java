...
public interface ExtensionProvider<T> {
	 ...
	 *            The class for which implementations are being looked up.
	 * 
	 * @return A list of objects implementing <tt>extensionPoint</tt>, or an
	 *         empty list if no such objects are available.
	 */
