...
/**
 * Factory for ResourceStore creation. Looks for a resourceStoreImpl bean before
 * falling back to the dataDirectoryResourceStore bean. Used to override
 * ResourceStore implementation if desired.
 */
	...
	public ResourceStore getObject() throws Exception {
		...
		try {
			...
			LOGGER.log(Level.FINER,
					"No resourceStoreImpl beans found, " + "falling back to DataDirectoryResourceStore");
		}
